...
export default function OrdersPage() {
  ...
  return (
    <div className="flex flex-col items-center gap-6 pt-3 min-h-screen overflow-y-auto">
      ...
      <div className="flex items-center w-full max-w-[480px] bg-[#111] border border-[#222] px-3 py-2 gap-2">
        ...
        />
        <button className="bg-transparent text-[#d42b2b] text-base cursor-pointer leading-none">
          ⊕
        </button>
      </div>

      <div className="flex flex-col gap-3 w-full py-10  max-w-none">
        {filtered.map((order) => (
          <div
        key={order.id}
