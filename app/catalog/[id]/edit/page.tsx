...
export default function EditCatalogItemPage() {
    return (
        <div className="flex flex-col gap-8 w-full relative">
            ...
            <form className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full items-stretch">
                {/* Kontainer Foto dengan fitur "Upload" style */}
                <div className="relative overflow-hidden rounded-sm border border-[#1a1a1a] bg-[#0f0f0f] w-full h-full min-h-[400px] group cursor-pointer">
                    <img
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center border border-[#1a1a1a] m-4 rounded-sm bg-[#0f0f0f]/70 p-6">
                        ...
                        <p className="text-[#888] font-mono text-xs tracking-[0.2em] uppercase">Click or Drag to Upload</p>
                ...
                <div className="flex flex-col gap-6 p-8 rounded-sm border border-[#1a1a1a] bg-[#0b0b0b] text-[#f0ece4] min-h-[500px] md:min-h-[600px]">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <textarea
                            ...
                            defaultValue="The NEO STUDIO 60HE+ is a high-performance desktop computer designed for professionals and gamers alike..."
                        />
                    </div>
                    ...
                    <div className="mt-auto pt-6 border-t border-[#1a1a1a] flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6">
                        ...
                        <div className="flex gap-4 w-full sm:w-auto">
                            <button type="button" className="flex-1 sm:flex-none px-6 py-3 border border-[#333] text-[#888] font-mono text-sm tracking-[0.1em] uppercase rounded-sm hover:bg-[#1a1a1a] transition-colors">
                                Cancel
                            </button>
                            <button type="submit" className="flex-1 sm:flex-none px-8 py-3 bg-[#d42b2b] text-white font-mono text-sm tracking-[0.1em] uppercase rounded-sm hover:bg-[#b02020] transition-colors">
                                Save Changes
                            </button>
                        </div>
                    </div>
